const Finger = {
	...
	getName: function (value: number): string | undefined {
		return this.nameMapping[value];
	},

	getPoints: function (value: number): number[][] | undefined {
		return this.pointsMapping[value];
	},
}
